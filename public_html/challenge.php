...
<head>
    ...
    <style>
        ...
        /* Make the links (or their surrounding area) change color on mouseover */
        a:hover {
          color: red;
        }

        /* Change the "bullet points" of this entire list to checkmarks (✓) */
        li:before {
          content: "✓";
          padding-right: 5px;
        }

        /* Use CSS to uppercase the first character of the content in the <h1> tag and the <a> tags */
        h1, a {
